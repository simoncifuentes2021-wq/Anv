...
export const relationship = {
  ...
  constellations: [
    ...
    },
    {
      ...
      memories: [
        { id: 'hogar-1', title: 'La confianza de ser nosotros', date: '[FECHA]', place: 'Nuestro presente', image: '/images/recuerdo-13.jpg', description: 'Hoy me siento profundamente agradecido por tenerte. Somos dos personas que pueden mostrarse tal como son, sin vergüenza y sin tener que esconder sus personalidades o sus caracteres. La confianza que hemos construido me permite ser yo mismo contigo, y saber que tú también puedes hacerlo conmigo es uno de los regalos más bonitos de nuestra relación.', quote: 'Nuestro amor también es la libertad de ser exactamente quienes somos.' },
        { id: 'hogar-2', title: 'Atardeceres contigo', date: '[FECHA]', place: 'Bajo nuestros atardeceres', image: '/images/recuerdo-14.jpg', description: 'Una de nuestras tradiciones es salir juntitos, conocer lugares que nos gustan y detenernos a mirar los atardeceres que tanto te encantan. Me gusta acompañarte mientras buscas esa fotografía bonita y estar ahí para apoyarte en todo. Cada paisaje se vuelve más especial porque lo estoy mirando contigo.', quote: 'He visto atardeceres preciosos, pero ninguno se compara con poder compartirlos contigo.' },
        { id: 'hogar-3', title: 'Cinco años y todo un futuro', date: '25 de septiembre de 2026', place: 'Nuestro quinto aniversario', image: '/images/recuerdo-15.jpg', description: 'Han sido cinco años llenos de aprendizajes, tanto personales como compartidos. Hemos aprendido a conocernos tal como somos, a apoyarnos y a crecer juntos. Te quiero y te amo por la persona que eres, y deseo seguir siendo para ti el mismo apoyo que tú has sido para mí. Imagino un futuro completo a tu lado: una familia, estabilidad, sueños compartidos y muchos logros que podamos celebrar juntos. Con la ayuda de Dios, quiero que sigamos unidos y que estos cinco años sean apenas el comienzo de toda una vida.', quote: 'Mi futuro favorito es aquel en el que seguimos caminando juntos, de la mano y con Dios acompañándonos.' },
      ],
    },
